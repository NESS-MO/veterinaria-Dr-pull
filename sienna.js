document.addEventListener("DOMContentLoaded", function() {
    ...
    <style>
        ...
        .asw-footer { position: absolute; bottom: 0; left: 0; right: 0; background: #1E2D93; padding: 16px; text-align: center; color: #fff; }
        ...
        .asw-adjust-font div[role=button] { background: #1E2D93; border-radius: 50%; width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; color: #fff; cursor: pointer; }
